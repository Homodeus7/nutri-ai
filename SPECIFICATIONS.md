...
2. [Пользовательские сценарии](#2-пользовательские-сценарии)
   - [2.1 Основные флоу](#21-основные-флоу)
3. [Экраны приложения](#3-экраны-приложения)
   - [3.1 Главная — Календарь](#31-главная--календарь)
   - [3.2 Экран заполнения дня](#32-экран-заполнения-дня)
   - [3.3 Настройки плана питания](#33-настройки-плана-питания)
   - [3.4 Добавление через AI](#34-добавление-через-ai)
4. [AI-интеграция](#4-ai-интеграция)
   - [4.1 Назначение](#41-назначение)
   - [4.2 Формат запроса](#42-формат-запроса)
   - [4.3 Формат ответа](#43-формат-ответа)
   - [4.4 Рекомендации по реализации](#44-рекомендации-по-реализации)
5. [Модель данных](#5-модель-данных)
   - [5.1 User](#51-user)
   - [5.2 DayEntry](#52-dayentry)
   - [5.3 Meal](#53-meal)
   - [5.4 FoodItem](#54-fooditem)
   - [5.5 DietPlan](#55-dietplan)
   - [5.6 AiParseLog](#56-aiparselog)
6. [API спецификация](#6-api-спецификация)
   - [6.1 Авторизация](#61-авторизация)
   - [6.2 Календарь](#62-календарь)
   - [6.3 Дневные записи](#63-дневные-записи)
   - [6.4 Приёмы пищи](#64-приёмы-пищи)
   - [6.5 AI](#65-ai)
   - [6.6 Планы питания](#66-планы-питания)
   - [6.7 Статистика](#67-статистика)
7. [Правила валидации](#7-правила-валидации)
   - [7.1 Общие правила](#71-общие-правила)
   - [7.2 AI-специфичные правила](#72-ai-специфичные-правила)
8. [Безопасность](#8-безопасность)
   - [8.1 Аутентификация](#81-аутентификация)
   - [8.2 Приватность данных](#82-приватность-данных)
9. [Мониторинг и метрики](#9-мониторинг-и-метрики)
   - [9.1 Обязательные метрики](#91-обязательные-метрики)
   - [9.2 Опциональные метрики](#92-опциональные-метрики)
