...
import { useCreateFood } from "../model/use-create-food";
...
export interface CreateFoodFormProps {
  onSuccess?: (foodItemData: FoodItemData) => void;
}

export function CreateFoodForm({ onSuccess }: CreateFoodFormProps) {
  const { t } = useI18n();
